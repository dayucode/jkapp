package com.jk.wyq.jkapp.UserModule.DatePicker;
...
public class DatePicker2 extends LinearLayout {
    ...
    private DatePickerView.OnDateSelectedListener onDateSelectedListener;// 日期多选后监听
     ...
     */
    public void setOnDatePickedListener(DatePickerView.OnDatePickedListener onDatePickedListener) {
     ...
     */
    public void setOnDateSelectedListener(DatePickerView.OnDateSelectedListener onDateSelectedListener) {
